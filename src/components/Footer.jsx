...
const Footer = () => {
  return (
    <footer className="bg-[#2c3328] mt-36 xl:px-20">
      <div className="flex items-center justify-between gap-10 px-8 py-10 border-b border-stone-500">
        ...
        <div className="flex flex-col gap-4 text-sm">
          <p>Phone: +855 2222 3333</p>
          <p>Email: plantlover@gmail.com</p>
          <p>Contact Us: info@platlover.com</p>
          ...
          <li>
            <a href="#">
              <svg
                ...
                height="25"
                viewBox="0 0 50 50"
                className="fill-white hover:fill-stone-400"
              >
